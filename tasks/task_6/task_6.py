...
if __name__ == "__main__":
    ...
    embed_config = {
        ...
        "project": "gemini-quizzify-429718",
        "location": "us-west1"
    }
    ...
    with screen.container():
        ...
        with st.form("Load Data to Chroma"):
            ...
            topic_input = st.text_input("Choose your quiz topic")
            no_of_questions = st.slider("Choose number of quiz questions", min_value=1, max_value=10, step=1)
            ####### YOUR CODE HERE #######
